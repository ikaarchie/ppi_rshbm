<div class="modal fade" id="editRekap{{ $rekaps->id }}" tabindex="-1" data-bs-backdrop="static"
    aria-labelledby="modalEditRekap" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditRekap">Ubah Data</h5>
