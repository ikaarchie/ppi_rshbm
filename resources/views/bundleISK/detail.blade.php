                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ ($isi->ISK0101 == 1) ? 'Ya' : (($isi->ISK0101 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <th>Pemasangan oleh petugas yang terlatih</th>
                                <td>{{ ($isi->ISK0102 == 1) ? 'Ya' : (($isi->ISK0102 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <th>Kebersihan tangan</th>
                                <td>{{ ($isi->ISK0103 == 1) ? 'Ya' : (($isi->ISK0103 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <th>Tehnik steril</th>
                                <td>{{ ($isi->ISK0104 == 1) ? 'Ya' : (($isi->ISK0104 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <tr>
                                <th>1</th>
                                <th>Hand hygiene</th>
                                <td>{{ ($isi->ISK0201 == 1) ? 'Ya' : (($isi->ISK0201 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <th>Perawatan cateter perineal setiap hari sesudah BAB</th>
                                <td>{{ ($isi->ISK0202 == 1) ? 'Ya' : (($isi->ISK0202 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <th>Urine bag tidak dilantai</th>
                                <td>{{ ($isi->ISK0203 == 1) ? 'Ya' : (($isi->ISK0203 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <th>Urine bag lebih rendah dari kandung kemih</th>
                                <td>{{ ($isi->ISK0204 == 1) ? 'Ya' : (($isi->ISK0204 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
