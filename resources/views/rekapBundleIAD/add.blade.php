<div class="modal fade" id="tambahRekapBundleIad" tabindex="-1" data-bs-backdrop="static"
    aria-labelledby="modalTambahRekapBundleIad" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahRekapBundleIad">Bundle IAD</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['url' => 'inputRekapBundle']) !!}
