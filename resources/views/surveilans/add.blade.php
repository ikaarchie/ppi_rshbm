    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('pa_ivl', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'pa_ivl', 'placeholder' => 'IVL',
                                'step'=>'any', 'required']) !!}
                                {!! Form::label('pa_ivl', 'IVL') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('pa_dc', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'pa_dc', 'placeholder' => 'DC',
                                'step'=>'any', 'required']) !!}
                                {!! Form::label('pa_dc', 'DC') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('pa_vent', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'pa_vent', 'placeholder' => 'Vent',
                                'step'=>'any', 'required']) !!}
                                {!! Form::label('pa_vent', 'Vent') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('pa_iad', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'pa_iad', 'placeholder' => 'IAD',
                                'step'=>'any', 'required']) !!}
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-2">
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_plebitis', '', ['style' => 'height: auto', 'class' =>
                                'form-control', 'id' => 'hais_plebitis', 'placeholder' => 'Plebitis',
                                'step'=>'any', 'required']) !!}
                                {!! Form::label('hais_plebitis', 'Plebitis') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_isk', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'hais_isk', 'placeholder' => 'ISK', 'step'=>'any', 'required']) !!}
                                {!! Form::label('hais_isk', 'ISK') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_vap', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'hais_vap', 'placeholder' => 'VAP', 'step'=>'any', 'required']) !!}
                                {!! Form::label('hais_vap', 'VAP') !!}
                            </div>
                        </div>
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_iad', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'hais_iad', 'placeholder' => 'IAD', 'step'=>'any', 'required']) !!}
                                {!! Form::label('hais_iad', 'IAD') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_deku', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'hais_deku', 'placeholder' => 'DEKU', 'step'=>'any', 'required']) !!}
                                {!! Form::label('hais_deku', 'DEKU') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_hap', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'hais_hap', 'placeholder' => 'HAP', 'step'=>'any', 'required']) !!}
                                {!! Form::label('hais_hap', 'HAP') !!}
                            </div>
                            <div class="col-sm-3 form-floating">
                                {!! Form::number('hais_ido', '', ['style' => 'height: auto', 'class' => 'form-control',
                                'id' => 'hais_ido', 'placeholder' => 'IDO', 'step'=>'any', 'required']) !!}
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <div class="col-sm-6 mb-3 form-floating">
                        {!! Form::number('terpajan', '', ['style' => 'height: auto', 'class' => 'form-control', 'id' =>
                        'terpajan', 'placeholder' => 'Karyawan Tertusuk Jarum', 'step'=>'any', 'required']) !!}
                        {!! Form::label('terpajan', 'Karyawan Tertusuk Jarum') !!}
                    </div>
                    <div class="col-sm-6 mb-3 form-floating">
                        {!! Form::number('tirah_baring', '', ['style' => 'height: auto', 'class' => 'form-control', 'id'
                        => 'tirah_baring', 'placeholder' => 'Pasien Tirah Baring', 'step'=>'any', 'required']) !!}
