                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ ($isi->IDO04B01 == 1) ? 'Ya' : (($isi->IDO04B01 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <th>Cuci tangan bedah (surgical scrub) dengan antiseptik standar (O)</th>
                                <td>{{ ($isi->IDO04B02 == 1) ? 'Ya' : (($isi->IDO04B02 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <th>Menggunakan APD lengkap (O)</th>
                                <td>{{ ($isi->IDO04B03 == 1) ? 'Ya' : (($isi->IDO04B03 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ ($isi->IDO05A01 == 1) ? 'Ya' : (($isi->IDO05A01 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <th>Gunakan tutup kepala sampai anak rambut</th>
                                <td>{{ ($isi->IDO05A02 == 1) ? 'Ya' : (($isi->IDO05A02 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <th>Tidak boleh menggunakan cover shoes untuk mencegah IDO</th>
                                <td>{{ ($isi->IDO05A03 == 1) ? 'Ya' : (($isi->IDO05A03 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <th>Gunakan sarung tangan steril setelah memakai gaun steril</th>
                                <td>{{ ($isi->IDO05A04 == 1) ? 'Ya' : (($isi->IDO05A04 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th colspan="4"></th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>{{ ($isi->IDO05B01 == 1) ? 'Ya' : (($isi->IDO05B01 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <th>Menggunakan antiseptik skin preparasi</th>
                                <td>{{ ($isi->IDO05B02 == 1) ? 'Ya' : (($isi->IDO05B02 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <th>Suhu / kelembaban udara 19-20 derajat celcius / 40-60%</th>
                                <td>{{ ($isi->IDO05B03 == 1) ? 'Ya' : (($isi->IDO05B03 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <th>Pintu kamar bedah selalu tertutup kecuali untuk lewat alat, petugas dan pasien</th>
                                <td>{{ ($isi->IDO05B04 == 1) ? 'Ya' : (($isi->IDO05B04 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ ($isi->IDO0601 == 1) ? 'Ya' : (($isi->IDO0601 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <th>Rawat luka dengan tehnik steril menggunakan cairan NaCl</th>
                                <td>{{ ($isi->IDO0602 == 1) ? 'Ya' : (($isi->IDO0602 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <th>Pankes gizi, kebersihan diri, cara merawat luka dan mobilisasi</th>
                                <td>{{ ($isi->IDO0603 == 1) ? 'Ya' : (($isi->IDO0603 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <th>Menggunakan APD saat merawat luka sesuai kebutuhan</th>
                                <td>{{ ($isi->IDO0604 == 1) ? 'Ya' : (($isi->IDO0604 == 0) ? 'Tidak' : 'TDD') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
