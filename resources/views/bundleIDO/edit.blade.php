    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::model($isi, [ 'method' => 'patch','route' => ['updateBundleIdo', $isi->id] ]) !!}
                ...
                <div class="col-sm-12 mb-3 form-floating">
                    {!! Form::text('tindakan', $isi->tindakan, ['style' => 'height: auto', 'class' => 'form-control',
                    'id' => 'tindakan', 'placeholder' => 'Tindakan', 'required']) !!}
