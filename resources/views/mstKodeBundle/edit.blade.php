<div class="modal fade" id="editMaster{{$isi->id}}" tabindex="-1" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::model($isi, [ 'method' => 'patch','route' => ['updateMstKodeBundle', $isi->id] ]) !!}
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <div class="col-sm-3 mb-3 form-floating">
                        {!! Form::text('kode', $isi->kode, ['style' => 'height: auto', 'class' => 'form-control', 'id'
                        =>
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <div class="col-sm-6 mb-3 form-floating">
                        ...
                        ], $isi->fungsi, ['style' => 'height: auto', 'class' => 'form-select', 'id' =>
                        'fungsi', 'placeholder' =>
                    ...
                    <div class="col-sm-6 mb-3 form-floating">
                        ...
                        ], $isi->jenis, ['style' => 'height: auto', 'class' => 'form-select', 'id' =>
                        'jenis', 'placeholder' =>
