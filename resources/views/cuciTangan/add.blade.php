<div class="modal fade" id="cuciTangan" tabindex="-1" data-bs-backdrop="static" aria-labelledby="modalCuciTangan"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCuciTangan">Tambah Data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['url' => 'cuciTangan/save']) !!}
                {!! Form::hidden('id') !!}
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                !!}
                                {!! Form::label('sbl_kon_psn', 'Tidak kesempatan', ['class' => 'form-check-label']) !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                'required')
                                !!}
                                {!! Form::label('sbl_tin_aseptik', 'Tidak kesempatan', ['class' => 'form-check-label'])
                                !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                'required')
                                !!}
                                {!! Form::label('stl_kon_cairan', 'Tidak kesempatan', ['class' => 'form-check-label'])
                                !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                !!}
                                {!! Form::label('stl_kon_psn', 'Tidak kesempatan', ['class' => 'form-check-label']) !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                'required') !!}
                                {!! Form::label('stl_kon_ling_psn', 'Tidak kesempatan', ['class' => 'form-check-label'])
                                !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                {!! Form::label('hr', 'Tidak kesempatan', ['class' => 'form-check-label']) !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                {!! Form::label('hw', 'Tidak kesempatan', ['class' => 'form-check-label']) !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center mb-2">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                {!! Form::label('gagal', 'Tidak kesempatan', ['class' => 'form-check-label']) !!}
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-sm-center">
                            ...
                            <div class="col-sm-6 text-end">
                                ...
                                {!! Form::label('st', 'Tidak kesempatan', ['class' => 'form-check-label']) !!}
                            </div>
                        </div>
                    </div>
                </div>
