...
<div class="container-fluid justify-content-center bg-white">
    <div class="d-md-flex justify-content-between">
        <div class="gap-1 d-md-flex justify-content-md-start mt-2">
            <button type="button" data-bs-toggle="modal" data-bs-target="#bundleVAP" class="btn"
    ...
    <div class="table-responsive mt-1 table-data tbl-fixed">
        <table class="table table-bordered border-dark align-middle w-100" id="myTable">
            ...
            <tbody style=" background-color: #FFECB3">
                @php $no = 1; @endphp
                @forelse($bundleVAP as $key => $isi)
                <tr>
                    <td>{{ $bundleVAP->firstItem() + $key }}</td>
                    <td>{{ $isi->mrn }}</td>
                    ...
                    <td>
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            <a href="#detailBundleVAP{{ $isi->id }}" data-bs-toggle="modal"
                                class="btn btn-sm btn-primary"><i class="fa-regular fa-eye"></i> Detail</a>
                            <a href="#editBundleVAP{{ $isi->id }}" data-bs-toggle="modal"
    ...
    $('.deleteSwal').click(function(){  
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "bundleVap/delete/"+id+""
                swalWithBootstrapButtons.fire(
                    'Terhapus!',
