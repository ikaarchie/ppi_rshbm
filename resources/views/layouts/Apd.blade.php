...
<div class="header-waves">
    <div class="container pt-3">
        <h1 class="text-center"><b>AUDIT APD</b></h1>
...
<div class="container-fluid wrapper mb-3">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link {{ Request::is('apd') ? 'active' : '' }}" aria-current="page"
                href="{{ route('getDataAPD') }}">Tambah Data</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('rekapAPD') ? 'active' : '' }}" href="{{ route('rekapAPD') }}">Rekap
                Data</a>
        </li>
    </ul>
</div>
