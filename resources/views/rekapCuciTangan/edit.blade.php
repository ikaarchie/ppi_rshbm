<div class="modal fade" id="editRekapCuciTangan{{ $rekaps->id }}" tabindex="-1" data-bs-backdrop="static"
    aria-labelledby="modalEditRekapCuciTangan" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditRekapCuciTangan">Ubah Data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                {!! Form::model($rekaps, [ 'method' => 'patch','route' => ['updateRekapCuciTangan', $rekaps->id] ]) !!}
